...
```{r}
plot(interval_vals, ave_steps_interval, type = "l", xlab = "Intervals", ylab = "Average Number of Steps", main = "Average Number of Steps Per Day")
```
...
```{r}
library(lattice) 
xyplot(ave_steps_interval ~ interval_vals | week, type = "l", 
       layout = c(1, 2), main = "Average Steps Over 24 Hour Period", 
       xlab = "5 min Intervals", ylab = "Average Number of Steps", data = week_df)
```
